<div class="flex flex-wrap mx-auto mt-12 mb-5">
    ...
    <div class="w-full md:w-9/12">
        ...
        @endforeach
        @if (!empty($letter['related_resources']) && isset($letter['related_resources'][0]['title']))
        ...
        @endisset
        <a href="{{ $dbUrl }}/edit/{{ $letter['uuid'] }}" target="_blank" rel="noopener noreferrer"
